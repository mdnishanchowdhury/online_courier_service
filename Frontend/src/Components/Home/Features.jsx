  ...
  <section className="py-16 sm:py-24 bg-gray-50">
    <div className="container mx-auto px-6">
      ...
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Why Choose Our Service</h2>
        <p className="text-lg text-gray-600">We combine speed, security, and outstanding service to provide a delivery experience you can trust.</p>
      </div>
